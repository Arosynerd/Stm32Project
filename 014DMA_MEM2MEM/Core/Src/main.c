...
const uint8_t srcBuffer[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A};
uint8_t dstBuffer[10] = {0};
uint8_t isFinish = 0;
void DMA_Transmit_Complete_Callback(DMA_HandleTypeDef * _hdma);
